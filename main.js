...
const BUILTIN_TEMPLATES = [
  { file: "workspace-bob.json", data: {"_template":{"id":"bob-workspace","label":"BOB Workspace","description":"Full workspace: Planner, CRM, PRM, Client Work, Finance, Suppliers & Procurement, Reports, AI Workspace. Schema-driven. Designed for the BOB Workspace vault.","order":1},"schemas":{"enabled":true,"folder":"00-CORE/Schemas/source"},"navigation":{"groups":[{"id":"home_group","label":"","items":[{"id":"home","label":"Home","icon":"home","desc":"Command centre \u2014 today, projects, pipeline and upcoming, all on one screen."}]},{"id":"planner","label":"Planner","module":"planner","items":[{"id":"planner.inbox","label":"Inbox","icon":"inbox","module":"planner","desc":"Universal capture + reminders. Anything you toss in here surfaces at the right time."},{"id":"planner.today","label":"Today","icon":"sun","module":"planner","desc":"Diary view of today's daily note."},{"id":"planner.calendar","label":"Calendar","icon":"calendar-days","module":"planner","desc":"Week view across daily notes."},{"id":"planner.tasknotes","label":"TaskNotes","icon":"circle-check-big","module":"planner","entityKey":"task","folderKey":"taskNotesFolder","desc":"TaskNotes as full markdown task records with status, priority, due date and context."},{"id":"planner.projects","label":"Projects","icon":"folder-kanban","module":"planner","entityKey":"project","folderKey":"folderProjects","desc":"Active projects with milestones, owners, statuses \u2014 kanban over project notes."}]},{"id":"crm","label":"CRM","module":"crm","items":[{"id":"crm.dashboard","label":"Dashboard","icon":"layout-grid","module":"crm","desc":"Overview cards \u2014 today's tasks, deal momentum, recent contacts, week stats."},{"id":"crm.pipeline","label":"Pipeline","icon":"trending-up","module":"crm","entityKey":"deal","folderKey":"folderPipeline","desc":"Sales pipeline. Deals as markdown notes with stage, deal value, client and follow-up frontmatter."},{"id":"crm.contacts","label":"Contacts","icon":"users","module":"crm","entityKey":"contact","folderKey":"folderContacts","desc":"People as markdown notes \u2014 name, email, company, last-talked-to cadence, tags."},{"id":"crm.clients","label":"Clients","icon":"briefcase","module":"crm","entityKey":"client","folderKey":"folderClients","desc":"Client company profiles \u2014 status, regions, contact details, related deals and projects."},{"id":"crm.leads","label":"Leads","icon":"target","module":"crm","entityKey":"lead","folderKey":"folderLeads","desc":"Prospect records \u2014 qualification, source, outreach status."},{"id":"crm.campaigns","label":"Campaigns","icon":"megaphone","module":"crm","entityKey":"campaign","folderKey":"folderCampaigns","desc":"Marketing/sales campaigns \u2014 outbound (sequences), inbound (content+ads), or mixed."},{"id":"crm.activities","label":"Activities","icon":"calendar","module":"crm","entityKey":"activity","folderKey":"folderActivities","desc":"Cross-cutting activity timeline \u2014 calls, meetings, telegram/whatsapp/email logs."}]},{"id":"prm","label":"PRM","module":"prm","items":[{"id":"prm.partners","label":"Partners","icon":"handshake","module":"prm","entityKey":"partner","folderKey":"folderPartners","desc":"Partner organisations \u2014 relationship status, named contacts, joint pipeline."}]},{"id":"client-work","label":"Client Work","module":"client-work","items":[{"id":"client-work.overview","label":"Workspace","icon":"briefcase-business","module":"client-work","desc":"Client delivery workspace: meetings, communications, deliverables, feedback, surveys, testimonials and decisions."}]},{"id":"finance","label":"Finance","module":"finance","items":[{"id":"finance.invoices","label":"Customer Invoices","icon":"receipt","module":"finance","entityKey":"invoice","desc":"Customer invoices, payment status and amounts."},{"id":"finance.gl","label":"General Ledger","icon":"book-open","module":"finance","desc":"GL work area for chart of accounts, journal entries, trial balances and financial statements."},{"id":"finance.setup","label":"Finance Setup","icon":"sliders-horizontal","module":"finance","desc":"Finance setup records: periods, bank accounts, FX rates and inventory/reference setup."},{"id":"tax.overview","label":"Tax","icon":"receipt-text","module":"finance","desc":"Tax and compliance work area: VAT, corporate tax, transfer pricing, free-zone status and retention."}]},{"id":"procurement","label":"Suppliers & Procurement","module":"procurement","items":[{"id":"procurement.suppliers","label":"Suppliers","icon":"truck","module":"procurement","entityKey":"supplier","folderKey":"folderSuppliers","desc":"Supplier profiles \u2014 services, contracts, contacts, spend."},{"id":"procurement.supplier-invoices","label":"Supplier Invoices","icon":"file-check-2","module":"procurement","entityKey":"supplier-invoice","desc":"Supplier invoices, three-way match and payment status."},{"id":"procurement.purchase-requisitions","label":"Purchase Requisitions","icon":"clipboard-list","module":"procurement","entityKey":"purchase-requisition","desc":"Internal purchase requests before spend is approved or a PO is issued."},{"id":"procurement.purchase-orders","label":"Purchase Orders","icon":"shopping-cart","module":"procurement","entityKey":"purchase-order","desc":"Formal supplier purchase orders, approval status and delivery references."}]},{"id":"reports","label":"Reports","items":[{"id":"reports.productivity","label":"Productivity","icon":"sun","desc":"Personal productivity \u2014 completion rate, streaks, focus blocks, journal volume."},{"id":"reports.pipeline","label":"Pipeline","icon":"trending-up","module":"crm","desc":"Pipeline coverage and weighted forecast \u2014 by stage, owner, source."},{"id":"reports.sales","label":"Sales","icon":"bar-chart-3","module":"crm","desc":"Closed won / lost trends \u2014 quota attainment, win rate, average cycle."},{"id":"reports.partners","label":"Partners","icon":"handshake","module":"prm","desc":"Partner contribution \u2014 sourced vs influenced revenue, top tiers."},{"id":"reports.activity","label":"Activity","icon":"pie-chart","module":"crm","desc":"Activity mix \u2014 calls, meetings, emails by rep and account."}]},{"id":"misc","label":"","items":[{"id":"team","label":"Team","icon":"user-cog","desc":"Team members, roles, seats \u2014 admin view of your BOB Workspace."},{"id":"settings","label":"Settings","icon":"settings-2","desc":"BOB Workspace settings \u2014 folders, headings, week start, API connection."}]},{"id":"ai","label":"AI Workspace","module":"ai","items":[{"id":"ai.playbooks","label":"Playbooks","icon":"book-open-check","module":"ai","entityKey":"playbook","folderKey":"folderPlaybooks","desc":"Runnable AI playbooks \u2014 step-by-step process recipes with triggers, outcomes and maturity levels."},{"id":"ai.skills","label":"Skills","icon":"cpu","module":"ai","entityKey":"skill","folderKey":"folderSkills","desc":"Agent skills installed in the vault \u2014 category, version, enabled/disabled status."}]}],"secondaryTabs":{"crm.campaigns":[{"label":"Overview","route":"crm.campaigns.overview"},{"label":"Campaigns","entityKey":"campaign"},{"label":"Sequences","entityKey":"sequence"}],"client-work.overview":[{"label":"Overview","route":"client-work.dashboard"},{"label":"Meetings","entityKey":"meeting"},{"label":"Comms","entityKey":"comms-thread"},{"label":"Deliverables","entityKey":"deliverable"},{"label":"Feedback","entityKey":"feedback"},{"label":"Surveys","entityKey":"survey"},{"label":"Testimonials","entityKey":"testimonial"},{"label":"Decisions","entityKey":"decision"}],"prm.partners":[{"label":"Overview","route":"prm.partners.overview"},{"label":"Partners","entityKey":"partner"},{"label":"Registrations","entityKey":"registration"},{"label":"Commissions","entityKey":"commission"},{"label":"Certifications","entityKey":"certification"},{"label":"Analytics","route":"prm.analytics"}],"finance.invoices":[{"label":"Customer Invoices","entityKey":"invoice"}],"finance.gl":[{"label":"Overview","route":"finance.gl.overview"},{"label":"Chart of Accounts","entityKey":"chart-of-accounts"},{"label":"Journal Entries","entityKey":"journal-entry"},{"label":"Bank Reconciliations","entityKey":"bank-reconciliation"},{"label":"Trial Balances","entityKey":"trial-balance"},{"label":"Statements","entityKey":"financial-statement"},{"label":"FS Notes","entityKey":"fs-notes"}],"finance.setup":[{"label":"Overview","route":"finance.setup.overview"},{"label":"Accounting Periods","entityKey":"accounting-period"},{"label":"Bank Accounts","entityKey":"bank-account"},{"label":"FX Rates","entityKey":"fx-rates-table"},{"label":"Inventory","entityKey":"inventory"}],"procurement.suppliers":[{"label":"Overview","route":"procurement.overview"},{"label":"Suppliers","entityKey":"supplier"},{"label":"Supplier Invoices","entityKey":"supplier-invoice"},{"label":"Purchase Requisitions","entityKey":"purchase-requisition"},{"label":"Purchase Orders","entityKey":"purchase-order"}],"tax.overview":[{"label":"Overview","route":"tax.dashboard"},{"label":"VAT Returns","entityKey":"vat-return"},{"label":"Corporate Tax","entityKey":"corporate-tax-return"},{"label":"Deferred Tax","entityKey":"deferred-tax"},{"label":"Transfer Pricing","entityKey":"transfer-pricing"},{"label":"Free Zone Status","entityKey":"free-zone-status"},{"label":"Legal Rules","entityKey":"legal-rule"},{"label":"Document Retention","entityKey":"document-retention"}]}},"workbookGroups":[{"id":"planner","label":"Planner","entityKeys":["task","project"]},{"id":"crm","label":"CRM","entityKeys":["deal","contact","client","company","lead","campaign","sequence","activity"]},{"id":"client-work","label":"Client Work","entityKeys":["meeting","comms-thread","deliverable","feedback","survey","testimonial","decision"]},{"id":"prm","label":"PRM","entityKeys":["partner","registration","commission","certification"]},{"id":"finance","label":"Finance","entityKeys":["invoice","chart-of-accounts","journal-entry","bank-reconciliation","trial-balance","financial-statement","fs-notes","accounting-period","bank-account","fx-rates-table","inventory","vat-return","corporate-tax-return","deferred-tax","transfer-pricing","free-zone-status","legal-rule","document-retention"]},{"id":"procurement","label":"Suppliers & Procurement","entityKeys":["supplier","supplier-invoice","purchase-requisition","purchase-order"]},{"id":"ai","label":"AI Workspace","entityKeys":["playbook","skill"]}],"settings":{"modules":{"crm":true,"client-work":true,"prm":true,"finance":true,"procurement":true,"tax":true,"planner":true,"ai":true}}} },
  { file: "workspace-cadence.json", data: {"_template":{"id":"cadence-classic","label":"Cadence Classic","description":"Original Cadence navigation: Planner, CRM, PRM and Client Work. Uses Cadence/ folder structure.","order":2},"schemas":{"enabled":false,"folder":"00-CORE/Schemas/source"},"navigation":{"groups":[{"id":"home_group","label":"","items":[{"id":"home","label":"Home","icon":"home","desc":"Command centre \u2014 today, projects, pipeline and upcoming, all on one screen."}]},{"id":"planner","label":"Planner","module":"planner","items":[{"id":"planner.inbox","label":"Inbox","icon":"inbox","module":"planner","desc":"Universal capture + reminders. Anything you toss in here surfaces at the right time."},{"id":"planner.today","label":"Today","icon":"sun","module":"planner","desc":"Diary view of today's daily note."},{"id":"planner.calendar","label":"Calendar","icon":"calendar-days","module":"planner","desc":"Week view across daily notes."},{"id":"planner.tasknotes","label":"TaskNotes","icon":"circle-check-big","module":"planner","entityKey":"task","folderKey":"taskNotesFolder","desc":"TaskNotes as full markdown task records with status, priority, due date and context."},{"id":"planner.projects","label":"Projects","icon":"folder-kanban","module":"planner","entityKey":"project","folderKey":"folderProjects","desc":"Active projects with milestones, owners, statuses \u2014 kanban over project notes."}]},{"id":"crm","label":"CRM","module":"crm","items":[{"id":"crm.dashboard","label":"Dashboard","icon":"layout-grid","module":"crm","desc":"Overview cards \u2014 today's tasks, deal momentum, recent contacts, week stats."},{"id":"crm.pipeline","label":"Pipeline","icon":"trending-up","module":"crm","entityKey":"deal","folderKey":"folderPipeline","desc":"Sales pipeline. Deals as markdown notes with stage, deal value, client and follow-up frontmatter."},{"id":"crm.contacts","label":"Contacts","icon":"users","module":"crm","entityKey":"contact","folderKey":"folderContacts","desc":"People as markdown notes \u2014 name, email, company, last-talked-to cadence, tags."},{"id":"crm.clients","label":"Clients","icon":"briefcase","module":"crm","entityKey":"client","folderKey":"folderClients","desc":"Client company profiles \u2014 status, regions, contact details, related deals and projects."},{"id":"crm.leads","label":"Leads","icon":"target","module":"crm","entityKey":"lead","folderKey":"folderLeads","desc":"Prospect records \u2014 qualification, source, outreach status."},{"id":"crm.campaigns","label":"Campaigns","icon":"megaphone","module":"crm","entityKey":"campaign","folderKey":"folderCampaigns","desc":"Marketing/sales campaigns \u2014 outbound (sequences), inbound (content+ads), or mixed."},{"id":"crm.activities","label":"Activities","icon":"calendar","module":"crm","entityKey":"activity","folderKey":"folderActivities","desc":"Cross-cutting activity timeline \u2014 calls, meetings, telegram/whatsapp/email logs."}]},{"id":"prm","label":"PRM","module":"prm","items":[{"id":"prm.partners","label":"Partners","icon":"handshake","module":"prm","entityKey":"partner","folderKey":"folderPartners","desc":"Partner organisations \u2014 relationship status, named contacts, joint pipeline."}]},{"id":"client-work","label":"Client Work","module":"client-work","items":[{"id":"client-work.overview","label":"Workspace","icon":"briefcase-business","module":"client-work","desc":"Client delivery workspace: meetings, communications, deliverables, feedback, surveys, testimonials and decisions."}]},{"id":"reports","label":"Reports","items":[{"id":"reports.pipeline","label":"Pipeline","icon":"trending-up","module":"crm","desc":"Pipeline coverage and weighted forecast \u2014 by stage, owner, source."},{"id":"reports.sales","label":"Sales","icon":"bar-chart-3","module":"crm","desc":"Closed won / lost trends \u2014 quota attainment, win rate, average cycle."},{"id":"reports.partners","label":"Partners","icon":"handshake","module":"prm","desc":"Partner contribution \u2014 sourced vs influenced revenue, top tiers."},{"id":"reports.activity","label":"Activity","icon":"pie-chart","module":"crm","desc":"Activity mix \u2014 calls, meetings, emails by rep and account."},{"id":"reports.productivity","label":"Productivity","icon":"sun","desc":"Personal productivity \u2014 completion rate, streaks, focus blocks, journal volume."}]},{"id":"misc","label":"","items":[{"id":"team","label":"Team","icon":"user-cog","desc":"Team members, roles, seats \u2014 admin view of your BOB Workspace."},{"id":"settings","label":"Settings","icon":"settings-2","desc":"BOB Workspace settings \u2014 folders, headings, week start, API connection."}]}],"secondaryTabs":{"crm.campaigns":[{"label":"Overview","route":"crm.campaigns.overview"},{"label":"Campaigns","entityKey":"campaign"},{"label":"Sequences","entityKey":"sequence"}],"client-work.overview":[{"label":"Overview","route":"client-work.dashboard"},{"label":"Meetings","entityKey":"meeting"},{"label":"Comms","entityKey":"comms-thread"},{"label":"Deliverables","entityKey":"deliverable"},{"label":"Feedback","entityKey":"feedback"},{"label":"Surveys","entityKey":"survey"},{"label":"Testimonials","entityKey":"testimonial"},{"label":"Decisions","entityKey":"decision"}],"prm.partners":[{"label":"Overview","route":"prm.partners.overview"},{"label":"Partners","entityKey":"partner"},{"label":"Registrations","entityKey":"registration"},{"label":"Commissions","entityKey":"commission"},{"label":"Certifications","entityKey":"certification"},{"label":"Analytics","route":"prm.analytics"}]}},"workbookGroups":[{"id":"planner","label":"Planner","entityKeys":["task","project"]},{"id":"crm","label":"CRM","entityKeys":["deal","contact","client","company","lead","campaign","sequence","activity"]},{"id":"client-work","label":"Client Work","entityKeys":["meeting","comms-thread","deliverable","feedback","survey","testimonial","decision"]},{"id":"prm","label":"PRM","entityKeys":["partner","registration","commission","certification"]}],"entities":{"contact":{"typeFilter":null,"folder":"Cadence/Contacts","fields":[{"key":"name","label":"Name","primary":true},{"key":"email","label":"Email","type":"email"},{"key":"company","label":"Company"},{"key":"role","label":"Role"},{"key":"lastContact","label":"Last contact","type":"date"},{"key":"tags","label":"Tags","type":"tags"}],"columns":["name","company","email","role","lastContact"]},"company":{"typeFilter":null,"folder":"Cadence/Companies","fields":[{"key":"name","label":"Name","primary":true},{"key":"domain","label":"Domain"},{"key":"industry","label":"Industry"},{"key":"size","label":"Size"},{"key":"owner","label":"Owner"},{"key":"tags","label":"Tags","type":"tags"}],"columns":["name","domain","industry","size","owner"]},"client":{"typeFilter":null,"folder":"Cadence/Clients"},"deal":{"typeFilter":null,"folder":"Cadence/Pipeline","fields":[{"key":"title","label":"Title","primary":true},{"key":"stage","label":"Stage","type":"enum","options":["Lead","Qualified","Proposal","Negotiation","Won","Lost"]},{"key":"value","label":"Value","type":"currency"},{"key":"company","label":"Company"},{"key":"contact","label":"Contact"},{"key":"owner","label":"Owner"},{"key":"closeBy","label":"Close by","type":"date"}],"columns":["title","stage","value","company","closeBy"],"valueField":"value","closeByField":"closeBy","wonStages":["Won"],"lostStages":["Lost"]},"lead":{"typeFilter":null,"folder":"Cadence/Leads","fields":[{"key":"name","label":"Name","primary":true},{"key":"company","label":"Company"},{"key":"source","label":"Source"},{"key":"status","label":"Status","type":"enum","options":["New","Contacted","Qualified","Disqualified","Converted"]},{"key":"assigned","label":"Assigned"}],"columns":["name","company","source","status","assigned"]},"partner":{"typeFilter":null,"folder":"Cadence/Partners","fields":[{"key":"name","label":"Name","primary":true},{"key":"tier","label":"Tier","type":"enum","options":["Gold","Silver","Bronze","Standard"]},{"key":"status","label":"Status","type":"enum","options":["Active","Onboarding","Inactive","Churned"]},{"key":"owner","label":"Owner"},{"key":"region","label":"Region"}],"columns":["name","tier","status","region","owner"]},"registration":{"typeFilter":null,"folder":"Cadence/Registrations","fields":[{"key":"title","label":"Title","primary":true},{"key":"partner","label":"Partner"},{"key":"status","label":"Status","type":"enum","options":["Submitted","Approved","Rejected","Expired"]},{"key":"value","label":"Value","type":"currency"},{"key":"expires","label":"Expires","type":"date"}],"columns":["title","partner","status","value","expires"]},"commission":{"typeFilter":null,"folder":"Cadence/Commissions","fields":[{"key":"reference","label":"Ref","primary":true},{"key":"partner","label":"Partner"},{"key":"amount","label":"Amount","type":"currency"},{"key":"status","label":"Status","type":"enum","options":["Pending","Earned","Paid","Disputed"]},{"key":"period","label":"Period"},{"key":"paidOn","label":"Paid on","type":"date"}],"columns":["reference","partner","amount","status","period","paidOn"]},"certification":{"typeFilter":null,"folder":"Cadence/Certifications","fields":[{"key":"name","label":"Name","primary":true},{"key":"partner","label":"Partner"},{"key":"level","label":"Level"},{"key":"issued","label":"Issued","type":"date"},{"key":"expires","label":"Expires","type":"date"}],"columns":["name","partner","level","issued","expires"]},"activity":{"typeFilter":null,"folder":"Cadence/Activities","fields":[{"key":"subject","label":"Subject","primary":true},{"key":"type","label":"Type","type":"enum","options":["Call","Email","Meeting","Note","Task"]},{"key":"when","label":"When","type":"date"},{"key":"with","label":"With"},{"key":"related","label":"Related"}],"columns":["when","type","subject","with","related"]},"sequence":{"typeFilter":null,"folder":"Cadence/Sequences","fields":[{"key":"name","label":"Name","primary":true},{"key":"audience","label":"Audience"},{"key":"steps","label":"Steps","type":"number"},{"key":"active","label":"Active","type":"number"},{"key":"status","label":"Status","type":"enum","options":["Draft","Active","Paused","Archived"]}],"columns":["name","audience","steps","active","status"]},"campaign":{"typeFilter":null,"folder":"Cadence/Campaigns"},"project":{"typeFilter":null,"folder":"Cadence/Projects","fields":[{"key":"name","label":"Name","primary":true},{"key":"status","label":"Status","type":"enum","options":["active","on_hold","backlog","done","cancelled"]},{"key":"priority","label":"Priority","type":"enum","options":["low","medium","high"]},{"key":"owner","label":"Owner"},{"key":"due","label":"Due","type":"date"}],"columns":["name","status","owner","due"]},"meeting":{"typeFilter":null},"comms-thread":{"typeFilter":null},"deliverable":{"typeFilter":null},"feedback":{"typeFilter":null},"survey":{"typeFilter":null},"testimonial":{"typeFilter":null},"decision":{"typeFilter":null}},"settings":{"modules":{"crm":true,"client-work":true,"prm":true,"planner":true}}} },
  { file: "workspace-crm.json", data: {"_template":{"id":"crm-only","label":"CRM Only","description":"Focused CRM workspace: Pipeline, Contacts, Clients, Leads, Campaigns, Activities and Reports. No Finance, PRM or Procurement modules.","order":3},"schemas":{"enabled":false,"folder":"00-CORE/Schemas/source"},"navigation":{"groups":[{"id":"home_group","label":"","items":[{"id":"home","label":"Home","icon":"home","desc":"Command centre \u2014 today, projects, pipeline and upcoming, all on one screen."}]},{"id":"planner","label":"Planner","module":"planner","items":[{"id":"planner.inbox","label":"Inbox","icon":"inbox","module":"planner","desc":"Universal capture + reminders."},{"id":"planner.today","label":"Today","icon":"sun","module":"planner","desc":"Diary view of today's daily note."},{"id":"planner.tasknotes","label":"TaskNotes","icon":"circle-check-big","module":"planner","entityKey":"task","folderKey":"taskNotesFolder","desc":"TaskNotes as full markdown task records."}]},{"id":"crm","label":"CRM","module":"crm","items":[{"id":"crm.dashboard","label":"Dashboard","icon":"layout-grid","module":"crm","desc":"Overview cards \u2014 today's tasks, deal momentum, recent contacts, week stats."},{"id":"crm.pipeline","label":"Pipeline","icon":"trending-up","module":"crm","entityKey":"deal","folderKey":"folderPipeline","desc":"Sales pipeline kanban over deal notes."},{"id":"crm.contacts","label":"Contacts","icon":"users","module":"crm","entityKey":"contact","folderKey":"folderContacts","desc":"People as markdown notes \u2014 name, email, company, tags."},{"id":"crm.clients","label":"Clients","icon":"briefcase","module":"crm","entityKey":"client","folderKey":"folderClients","desc":"Client company profiles."},{"id":"crm.leads","label":"Leads","icon":"target","module":"crm","entityKey":"lead","folderKey":"folderLeads","desc":"Prospect records \u2014 qualification, source, outreach status."},{"id":"crm.campaigns","label":"Campaigns","icon":"megaphone","module":"crm","entityKey":"campaign","folderKey":"folderCampaigns","desc":"Marketing/sales campaigns."},{"id":"crm.activities","label":"Activities","icon":"calendar","module":"crm","entityKey":"activity","folderKey":"folderActivities","desc":"Cross-cutting activity timeline."}]},{"id":"reports","label":"Reports","items":[{"id":"reports.pipeline","label":"Pipeline","icon":"trending-up","module":"crm","desc":"Pipeline coverage and weighted forecast."},{"id":"reports.sales","label":"Sales","icon":"bar-chart-3","module":"crm","desc":"Closed won / lost trends."},{"id":"reports.activity","label":"Activity","icon":"pie-chart","module":"crm","desc":"Activity mix \u2014 calls, meetings, emails."},{"id":"reports.productivity","label":"Productivity","icon":"sun","desc":"Personal productivity \u2014 completion rate, streaks."}]},{"id":"misc","label":"","items":[{"id":"team","label":"Team","icon":"user-cog","desc":"Team members, roles, seats."},{"id":"settings","label":"Settings","icon":"settings-2","desc":"BOB Workspace settings."}]}],"secondaryTabs":{"crm.campaigns":[{"label":"Overview","route":"crm.campaigns.overview"},{"label":"Campaigns","entityKey":"campaign"},{"label":"Sequences","entityKey":"sequence"}]}},"workbookGroups":[{"id":"planner","label":"Planner","entityKeys":["task","project"]},{"id":"crm","label":"CRM","entityKeys":["deal","contact","client","company","lead","campaign","sequence","activity"]}],"settings":{"modules":{"crm":true,"planner":true}}} },
  { file: "workspace-minimal.json", data: {"_template":{"id":"minimal","label":"Minimal","description":"Blank slate: just Home and Settings. Build your own navigation from the Navigation designer in Settings \u2192 BOB Workspace \u2192 Workspace.","order":4},"schemas":{"enabled":false,"folder":"00-CORE/Schemas/source"},"navigation":{"groups":[{"id":"home_group","label":"","items":[{"id":"home","label":"Home","icon":"home","desc":"Command centre \u2014 today, projects, pipeline and upcoming, all on one screen."}]},{"id":"misc","label":"","items":[{"id":"team","label":"Team","icon":"user-cog","desc":"Team members, roles, seats."},{"id":"settings","label":"Settings","icon":"settings-2","desc":"BOB Workspace settings."}]}],"secondaryTabs":{}},"workbookGroups":[],"settings":{"modules":{"planner":true}}} },
];
...
async function seedWorkspaceTemplates(app) {
  ...
  for (const tpl of BUILTIN_TEMPLATES) {
    const path = `${dir}/${tpl.file}`;
    if (!(await adapter.exists(path))) {
      try {
        await adapter.mkdir(dir);
        await adapter.write(path, JSON.stringify(tpl.data, null, 2));
      } catch (_) {}
    }
  }
}
...
async function loadWorkspaceTemplates(app) {
  ...
  // Fall back to embedded built-in templates when folder is absent or empty
  return BUILTIN_TEMPLATES.map((t) => t.data).sort((a, b) => (a._template.order || 99) - (b._template.order || 99));
}
