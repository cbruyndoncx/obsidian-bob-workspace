...
export class CadenceSettingTab extends obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new obsidian.Setting(navPanel)
      ...
      .setDesc('Show lower-frequency child surfaces (e.g. campaign sub-tabs, finance children) directly in the left rail. When off, they stay reachable via their parent surface\'s tabs.')
      .addToggle((t) => t
    ...
    new obsidian.Setting(navPanel)
      .setName('Show setup nav items')
      .setDesc('Show setup-level surfaces (marked navLevel "setup") in the left rail. Off by default to keep the rail focused on day-to-day work.')
      .addToggle((t) => t
